...
/****** Object:  View [dbo].[TIMESERIES_PLANT_CONSUMPTION_V]    Script Date: 04-10-2017 18:07:22 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[TIMESERIES_PLANT_CONSUMPTION_V] 
...
WHERE EAC.type =1 and ETD.wages_type=4
