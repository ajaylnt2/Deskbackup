...
/****** Object:  View [dbo].[ASSET_ACTUAL_BUDGET_CONSUMPTION]    Script Date: 04-10-2017 17:42:10 ******/
SET ANSI_NULLS ON
GO
...
-- Description: ASSET_ACTUAL_BUDGET_CONSUMPTION
-- ========================================================================
CREATE VIEW [dbo].[ASSET_ACTUAL_BUDGET_CONSUMPTION]
AS
SELECT
Month_ID,
SUBSTRING(DATENAME(month, 
(
   CAST(Year_id AS varchar(4)) + '-' + CAST(Month_ID as varchar(2)) + '-' + CAST(1 as varchar(1))
)
), 1, 3) as monthName,
Year_id,
wages_type,
...
FROM emms_consumption_actual eca FULL OUTER JOIN
