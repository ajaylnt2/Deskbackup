...
/****** Object:  View [dbo].[TIMESERIES_PLANTDEPT_CONSUMPTION_V]    Script Date: 04-10-2017 18:07:41 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[TIMESERIES_PLANTDEPT_CONSUMPTION_V]      
AS     
SELECT   

   EAC.Plant_ID,    	ETD.Asset_ID,     
	ETD.Wages_type,     
	EU.Description UOM,     
	DATEID,     
	ett.MONTHID,   
