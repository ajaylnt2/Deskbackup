...
/****** Object:  View [dbo].[ASSET_MTP_PERFORMANCE]    Script Date: 04-10-2017 17:58:31 ******/
SET ANSI_NULLS ON
GO
...
-- Description: ASSET_MTP_PERFORMANCE
-- ========================================================================

CREATE VIEW [dbo].[ASSET_MTP_PERFORMANCE]
AS
...
((SUM(PRODUCTION_CY)-SUM(PRODUCTION_BY))/SUM(PRODUCTION_BY)) AS YTP_PERFORMANCE
