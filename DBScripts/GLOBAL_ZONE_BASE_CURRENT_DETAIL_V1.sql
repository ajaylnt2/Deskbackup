...
/****** Object:  View [dbo].[GLOBAL_ZONE_BASE_CURRENT_DETAIL_V1]    Script Date: 04-10-2017 18:02:06 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	GLOBAL_ZONE_BASE_CURRENT_DETAIL_V  1

-- ========================================================================  

CREATE VIEW [dbo].[GLOBAL_ZONE_BASE_CURRENT_DETAIL_V1]  
...
FROM   
	...
	ETSD.Wages_type wages, Cost_USD as Cost_BY,consumption as Consumption_BY,GlobalEnergyConsumption,
